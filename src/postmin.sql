...
--
-- Table structure for table `opendkim`
--
 
DROP TABLE IF EXISTS `opendkim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opendkim` (
  `dkimid` int(11) NOT NULL AUTO_INCREMENT,
  `domainid` int(11) NOT NULL,
  `keytable` text COLLATE utf8_bin NOT NULL,
  `signingtable` text COLLATE utf8_bin NOT NULL,
  `privatekey` text COLLATE utf8_bin NOT NULL,
  `dnstxtrecord` text COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`dkimid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
 
--
-- Dumping data for table `opendkim`
--
 
LOCK TABLES `opendkim` WRITE;
/*!40000 ALTER TABLE `opendkim` DISABLE KEYS */;
/*!40000 ALTER TABLE `opendkim` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-06-02  9:10:42
